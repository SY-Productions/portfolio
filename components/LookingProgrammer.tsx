...
const LookingProgrammer = memo(function LookingProgrammer() {
  return (
    <div className="relative font-[ybb] w-full text-white h-auto min-h-[15vh] flex flex-col md:flex-row items-center justify-between py-[6vh] gap-8 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-[#0F3D3E]/50 to-[#8C9EFF]/50"></div>
      <div className="absolute bottom-0 left-0 w-full h-[1px] bg-gradient-to-r from-[#8C9EFF]/50 to-[#0F3D3E]/50"></div>
      ...
      <div
        className="absolute top-10 right-1/4 w-32 h-32 bg-[#0F3D3E]/15 rounded-full blur-2xl animate-pulse"
      ...
      <a
        ...
        className="font-[ybb] w-[60vw] md:w-[15vw] h-[6vh] md:ml-[10vw]
                  ...
                  bg-gradient-to-r from-[#0F3D3E]/20 to-[#8C9EFF]/20
