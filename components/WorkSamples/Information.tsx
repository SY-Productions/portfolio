  ...
  return (
    <div className="INFORMATION flex items-center justify-center lg:justify-normal">
      ...
      >
        ...
        <button
          onClick={() => handleOpeningDrawer(true)}
          className="absolute bottom-0 flex items-center justify-between px-4 hover:bg-b/70 bg-b/60 text-white w-full h-[5vh] min-h-12"
        >
