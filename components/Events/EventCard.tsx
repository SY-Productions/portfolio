...
const EventCard = memo(function EventCard({ data }: { data: Event }) {
  return (
    <div className="group w-[80vw] lg:w-[30vw] min-w-[150px] h-auto min-h-[12rem]
      ...
      <div className="NAME&DESC flex flex-col px-4">
        ...
        <div className="relative text-lg py-2 text-white font-bold h-20 overflow-hidden">
          {data.name}
          <span className="absolute -bottom-1 right-0 w-12 h-[2px] bg-gradient-to-r from-[#66FF91] to-[#37B13B]"></span>
        </div>
      ...
      <div className="relative w-[90%] h-[350px] mx-auto rounded-none my-8 overflow-hidden border border-white/10
