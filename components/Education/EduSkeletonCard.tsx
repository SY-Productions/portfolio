  ...
  return (
    <div className="glass-card w-[80vw] lg:w-[30vw] min-w-[150px] h-auto min-h-[12rem] mx-auto flex flex-col font-[ybn]">
      ...
      <div className="NAME&DESC flex flex-col px-5">
        {/* Title placeholder */}
        <div className="py-2">
          <div className="h-6 w-[70%] bg-white/10 animate-pulse rounded-sm"></div>
        </div>

        {/* Description placeholder */}
        <div className="pb-5">
          <div className="h-4 w-full bg-white/10 animate-pulse mb-2 rounded-sm"></div>
          <div className="h-4 w-[90%] bg-white/10 animate-pulse mb-2 rounded-sm"></div>
          <div className="h-4 w-[80%] bg-white/10 animate-pulse rounded-sm"></div>
        </div>
      </div>
    </div>
  );
...
export default EduCardSkeleton;
