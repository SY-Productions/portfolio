...
const CallMe = memo(function CallMe() {
  ...
  return (
    <div
      id="call-me"
      className="section-shell h-auto lg:h-screen flex flex-col lg:flex-row justify-center items-center gap-[5vh] lg:gap-6 mt-[5vh] pb-12"
    >
      <div
      ...
      <div className="(H3&P)&(FORM) w-full lg:basis-1/2 relative z-10">
        <div className="H3&P w-full">
      ...
      <div className="w-full lg:basis-1/2 relative z-10">
        <PicInfo />
      </div>
    </div>
  );
