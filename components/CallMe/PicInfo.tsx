...
export default function PicInfo() {
  return (
    <div className="relative lg:basis-1/2 w-[80vw] lg:w-full h-[400px] overflow-hidden flex justify-center items-center">
      ...
      />
      <div className="TXTonPIC absolute flex flex-col sm:flex-row items-center justify-between gap-2 px-2 sm:px-8 lg:px-4 x  py-4 bg-d/40 backdrop-blur-md drop-shadow-lg w-full bottom-5 [&>*]:text-xs sm:[&>*]:text-sm [&>*]:gap-y-1 sm:[&>*]:py-0  [&>*]:text-white ">
